    ...
    public class WhisperManager : MonoBehaviour
    {
        ...
        public async Task InitModel()
        {
            ...
            try
            {
                ...
                if (_whisper == null)
                {
                    Debug.LogError("WhisperManager: _whisper is NULL after InitFromFileAsync!");
                }
                else
                {
                    Debug.Log("WhisperManager: _whisper successfully initialized!");
                }
        ...
        {
            Debug.Log("WhisperManager: Entered GetTextAsync");
